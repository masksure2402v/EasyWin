...
function mnjk(){
	...
	var bns = setInterval(function() {
		...
		if(x <= en){$('#wncx').html(x+'x');}
		
		if(sn >= 2 && sn < 3){xi=3;}
		else if(sn >= 3 && sn <4 ){xi=4;}
		else if(sn >= 4 && sn <6 ){xi=6;}
		else if(sn >= 6 && sn <8 ){xi=8;}
		else if(sn >= 8 && sn <10 ){xi=10;}
		else if(sn >= 10 && sn <20 ){xi=100;}
		else if(sn >= 20 && sn <50 ){xi=200;}
		else if(sn >= 50 && sn <100 ){xi=300;}
		else if(sn >= 100 && sn <300 ){xi=400;}
		else if(sn >= 300){xi=500;}
		
		if(sn >= en){stopanimation();clearInterval(bns);}
